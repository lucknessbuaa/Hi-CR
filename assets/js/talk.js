...
define('talk',['require','jquery','jquery.serializeObject','jquery.iframe-transport','bootstrap','moment','bootstrap-datetimepicker','zh-CN','select2','parsley','ajax_upload','django-csrf-support','when/when','underscore','backbone/backbone','errors','utils','formProto','formValidationProto','modals','simple-upload'],function(require) {
    require("jquery");
